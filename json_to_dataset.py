...
if __name__ == '__main__':
    jpgs_path = "original/JPEGImages"
    pngs_path = "original/SegmentationClass"
    # classes = ["_background_","cat","dog"]
    classes = ["_background_", "village", "wasteland", "unknow"]
    
    count = os.listdir("original/before_village/") 
    for i in range(0, len(count)):
        path = os.path.join("original/before_village", count[i])
